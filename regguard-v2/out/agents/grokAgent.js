...
exports.findTrendingRegulations = findTrendingRegulations;
/**
...
async function findTrendingRegulations(config) {
    const model = (0, llm_1.buildModel)('grok', config.openRouterKey, { temperature: 0.2, maxTokens: 2500 });
